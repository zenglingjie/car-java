var hosturl = "http://localhost:8003"
//var weburl = "localhost:8002"
//var hosturl = "http://backtest"
var weburl = "backtest"
$(function () {
	$('#logouturl').attr("href", hosturl + '/webapp/logout.html');
    $('#loginurl').attr("href", hosturl + '/webapp/login.html');
	//下拉菜单
...
//	});
	...
	$(document).ready(function(){			
	    ...
	    var x = winHeight - 203;	    
	    var y = winHeight - 160;
//	    var yy = winWidth - $(".editStrategy_left").width() -100;
	    $(".creatStrategy").css("height",x);
	    $(".editStrategy_left").css("height",y);
	    $(".ace_content").css("height",y);
//	    $("#data-k>div:first-child").css("width",yy)
//	    $("#data-k canvas").css("width",yy)
	});
